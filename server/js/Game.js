...
var Game = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.currentQuestions = [];
                        this.arrangeQuestions(questionsFetched);
                        return [2 /*return*/];
                }
            });
        });
    ...
    Game.prototype.arrangeQuestions = function (questionsFetched) {
        ...
        questionsFetched.forEach(function (currFetchedQuestion) {
            ...
            if (_this.currentQuestions.filter(function (e) { return e.id == currFetchedQuestion.questionId; }).length != 0) {
                // if yes -> find the question and add the new answer with its id
                _this.currentQuestions
